package com.ratih.restaurantfinder.activity
...
import com.ratih.restaurantfinder.R
import com.ratih.restaurantfinder.adapter.MainAdapter
import com.ratih.restaurantfinder.adapter.MainAdapterHorizontal
import com.ratih.restaurantfinder.api.ApiEndpoint
import com.ratih.restaurantfinder.model.ModelMain
import com.ratih.restaurantfinder.model.ModelMainHorizontal
import com.ratih.restaurantfinder.utils.OnItemClickCallback
...
class MainActivity : AppCompatActivity(), LocationListener {
    ...
    private fun setSearchResto(query: String) {
        ...
        AndroidNetworking.get(ApiEndpoint.BASEURL + ApiEndpoint.CariResto + query + "&lat=" + lat + "&lon=" + lng + "&radius=20000")
            .addHeaders("user-key", "42f25e1d4904ceab00c97d84b5aa3b5e")
